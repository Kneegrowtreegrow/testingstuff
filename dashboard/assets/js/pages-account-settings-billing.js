...
document.addEventListener('sbAPILoaded', function() {
    ...
    if (userData[0].plan == "Royal") {
        document.getElementById("currentPlan").innerText = `Your Current Plan is Royalty`
        document.getElementById("description").innerText = `Enjoy the full power of Overdog's add-ons, and just know you are one of our favorite customers! We hope you enjoy your experience and feel free to talk with us at any time.`
    } else if (userData[0].plan == "Apprentice") {
        document.getElementById("currentPlan").innerText = `Your Current Plan is Apprentice`
        document.getElementById("description").innerText = `If you ever feel like our platform sucks, just upgrade!.`
    }
