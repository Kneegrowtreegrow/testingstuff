                    ...
                    <div class="card-body" style="padding-top:5px">
                        ...
                        <div class="row mt-4 align-items-center">
                            ...
                            <div class="col-6 d-flex justify-content-start">
                                <span style="width:40px;height: 40px;"><img src="../../assets/img/wnba-logos/${getTeamName(game.awayTeam.teamName).toLowerCase()}.svg" width="40px" height="40px"></span>
                            ...
                            <div class="col-6 justify-content-end text-align-right" style="position:absolute;right:-10%;top:25%">
                                <span class="quarter badge bg-${color}">${game.gameStatusText}</span><br>
                        ...
                        <div class="row mt-2 align-items-center">
                            <!-- Column 1: Celtics -->
                            <div class="col-6 d-flex justify-content-start">
                                <span style="width:40px;height: 40px;"><img src="../../assets/img/wnba-logos/${getTeamName(game.homeTeam.teamName).toLowerCase()}.svg" width="40px" height="40px"></span>
...
document.addEventListener('sbAPILoaded', function() {
    ...
    fetch(`https://cdn.overdogbets.com/predictions/wnba/${formattedDate}.json`, requestOptions)
...
function createPlayerCard(playerName, stats) {
    ...
    const imageUrl = playerId ? `https://cdn.wnba.com/headshots/wnba/latest/1040x760/${playerId}.png` : 'path/to/default/image.png';
    const roundedStats = Object.fromEntries(
        Object.entries(stats).map(([key, value]) => [key, Math.round(value * 100) / 100])
    );

    return `
                <div class="player-card card mb-3">
                    <div class="row mb-2" style="margin:20px">
                        <div class="col">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3><span>${playerName}</span></h3>
                                
                                <button class="btn btn-primary">Open Stats</button>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin:20px">
                    <div class="col">
                        <img src="${imageUrl}" alt="${playerName}" style="width: 50%;">
                            </div>
                        <div class="col">
                            <div class="d-flex justify-content-between align-items-center">
                                ${Object.entries(roundedStats).map(([stat, value]) => `
...
function searchPlayers() {
    ...
    const filteredData = playerData.filter(player => {
        const playerName = Object.keys(player)[0].toLowerCase();
