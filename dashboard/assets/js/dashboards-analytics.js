...
function buildTennisPredictions(predictions) {
    ...
    const tennisContainer = document.getElementById('tennis-picks');
    ...
    for (const game of predictions) {
        ...
        const cardTemplate = `
        <div class="ai-pick swiper-slide" style="width:350px !important">
...
function compareOdds(odd1, odd2) {
    const decimal1 = parseFloat(odd1.toString().split('.')[1][0]);
...
function preProcessPredictions(predictions) {
    ...
    buildMLBPredictions(predictions)
}



function buildMLBPredictions(predictions) {
    console.log(predictions)
    //buildParlays(predictions)
    const mlbContainer = document.getElementById('mlb-picks');
    ...
    for (const game of predictions) {
        ...
        const cardTemplate = `
        <div class="col-lg-3 col-sm-6 mb-4 ai-pick swiper-slide">
          <div class="card h-100">
              <div class="card-header">
                  <center>
              ...
              <div class="row">
                  <div class="col-4">
                      <div class="d-flex  align-items-center mb-2">
                          <span><img class="logo" src="https://www.mlbstatic.com/team-logos/team-cap-on-light/${getTeamId(game["awayteamfull"])}.svg" width="40px" height="40px"></span>
                          <p class="team-name1 mb-0 team-away">${getTeamName(game["awayteamfull"])}</p>
                      </div>
...
<image id="image0_79_9" width="500" height="500" xlink:href="data:image/png;base64,"/>
                  ...
                  <div class="col-4 text-end">
                      <div class="d-flex  justify-content-end align-items-center mb-2">
                          <p class=" team-name1 mb-0 team-home">${getTeamName(game["hometeamfull"])}</p>
                          <span><img class="logo" src="https://www.mlbstatic.com/team-logos/team-cap-on-light/${getTeamId(game["hometeamfull"])}.svg" width="40px" height="40px"></span>
                      </div>
    ...
    `;
        ...
        mlbContainer.innerHTML += cardTemplate;
    }
}